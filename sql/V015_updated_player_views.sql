-- ============================================================================
-- V015: Updated Player Training Features View (V2)
-- ============================================================================
-- Replaces V003's player_training_features with additional features from:
--   V007  player_expanded_rolling  — steals, blocks, turnovers, +/-, fouls
--   V013  player_game_referee_foul_risk — referee-driven foul tendency
-- ============================================================================
...
enriched AS (
    SELECT
        ...
        -- =============== NEW: V007 player expanded stats ===============
        pex.stl_avg_5,
        pex.stl_avg_10,
        pex.blk_avg_5,
        pex.blk_avg_10,
        ...
        pex.fg3_pct_avg_10,
        pex.ft_pct_avg_10,
        pex.plus_minus_avg_5,
        pex.plus_minus_avg_10,
        pex.fouls_avg_5,
        pex.fouls_avg_10,
        pex.ast_to_tov_ratio_avg_10,

        -- =============== NEW: V013 referee foul risk ===============
    ...
    -- V007: Player expanded rolling stats
    ...
    -- V013: Referee foul risk for this player in this game
    ...
    -- V006: Opponent team style (for matchup context)
...
SELECT
    ...
    -- Player rolling features (existing)
    n_games_prev_10,
    min_avg_5,
    min_avg_10,
    pts_avg_5,
    ...
    fouls_avg_5,
    fouls_avg_10,
    ast_to_tov_ratio_avg_10,

    -- ============== NEW: V013 referee foul risk ==============
    avg_foul_uplift_crew,
    avg_foul_per_36_uplift_crew,
    max_foul_uplift_crew,
    ref_games_with_crew,

    -- ============== NEW: V006 opponent style matchup ==============
    opp_fouls_avg_10,
    opp_stl_avg_10,
    opp_blk_avg_10,
    opp_pts_paint_avg_10,
    opp_fast_break_pct_10
