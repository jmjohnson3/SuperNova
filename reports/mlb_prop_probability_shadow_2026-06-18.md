# MLB Prop Probability Shadow - 2026-06-18
...
| model_plus_prior | 65072 | 0.158 | -0.9% | 9581 | -0.4% | 42.6% | +0.21 |
...
|---|---:|---|---:|---:|---:|---:|---:|
| batter_hits|over | 21394 | keep_model_only_clv | 0.161 | 0.160 | 1.4% | 24.6% | 45.5% |
...
| batter_total_bases|over | 22956 | keep_model_only | 0.163 | 0.162 | -14.5% | -7.4% | 42.6% |
...
| Bucket | Rows | Recommendation | Model Brier | Prior Brier | Model ROI | Prior ROI | Prior CLV beat |
|---|---:|---|---:|---:|---:|---:|---:|
| batter_hits|over|alt_tail | 5974 | keep_model_only | 0.030 | 0.029 | 16.4% | 25.8% | 45.5% |
| batter_hits|over|common | 15420 | keep_model_only_clv | 0.212 | 0.210 | -18.4% | 23.7% | 45.5% |
...
| batter_total_bases|over|common | 12892 | keep_model_only | 0.209 | 0.208 | -9.9% | -8.5% | 48.2% |
